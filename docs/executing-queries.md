...
| executorImplementationFactory | `callable`                                                           | Optional per-request executor factory. Use this to select an execution strategy without changing the process-wide executor factory.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
